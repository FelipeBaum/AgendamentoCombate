    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listCombates.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id){
                Intent intent=new Intent(TelaCombateRobosUsuarios.this, SetarStatus.class);
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    if(id.equals(jsonArray.getJSONObject(i).getString("usuario_robo1"))) {
                    ...
                    }else if(id.equals(jsonArray.getJSONObject(i).getString("usuario_robo2"))) {
