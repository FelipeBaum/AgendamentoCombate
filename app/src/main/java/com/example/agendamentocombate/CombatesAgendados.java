...
public class CombatesAgendados extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listCombates.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id){
                Intent intent=new Intent(CombatesAgendados.this, DetalhesCombates.class);
        ...
        btMudar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v){
                Intent intent=new Intent(CombatesAgendados.this, CombatesAgendar.class);
                startActivity(intent);
            }
        });
    ...
    private class DownloadDeDados extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            if (jsonFeed == null) {
                Toast.makeText(CombatesAgendados.this, "DownloadError", Toast.LENGTH_SHORT).show();
            }
            return jsonFeed;
        }
        ...
        private String downloadJson(String urlString) {
            ...
            try {
                ...
                Toast.makeText(CombatesAgendados.this, "Invalid URL", Toast.LENGTH_SHORT).show();
            } catch (IOException e) {
                Toast.makeText(CombatesAgendados.this, "IO Error In Download", Toast.LENGTH_SHORT).show();
            }
            return null;
        }
    }
